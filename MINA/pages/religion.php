...
<html>
<head>
  <title> Religion | Student Information Website </title>
...
<body>
	<header>
		<nav class="nav-extended">
    		<div class="nav-wrapper red darken-2">
              ...
              <li class="active"><a href="religion.php">Religion</a></li>
    		...
    		<div class="nav-content red darken-3">
              ...
              <?php
                if($religionadd == 1) {
                  echo '<li class="tab"><a href="#add">Add New Religion</a></li>';
                } else {
                  echo '<li class="tab disabled"><a href="#add">Add New Religion</a></li>';
                }
              ?>
    ...
    <div id="edit" class="modal modal-fixed-footer">
      <div class="modal-content">
        <h4>Edit Religion Details</h4>
        <div class="divider"></div>
        <div class="row">
          <form class="col s12" action="../commands/editreligion.php">
            <div class="row">
              <input id="idedit" name="idedit" type="hidden" class="validate">
              <div class="input-field col s12">
                <input placeholder='' id="nameedit" name="nameedit" type="text" class="validate" maxlength="60">
    ...
    <div id="list" class="col s12">
     <div class="container">
        <div class="section">
          <h5>List of Religions</h5>
          <p>You are currently viewing the list of religions recorded by the university. To sort, click on the heading.</p>
        </div>
        <div class="divider"></div>
        <?php
          include('../commands/databaseinfo.php');

          $sql = "SELECT * FROM religion ORDER BY id";
    ...
    ?>
      <div class="container">
        <div class="row">
          <div class="section">
            <h5>Add Religion Details</h5>
            <p>Insert new religion to record.</p>
          </div>
        </div>
        <div class="row divider"></div>
        <div class="row">
          <form class="col s12" method="post" action="../commands/insertreligion.php">
            <div class="row">
              <div class="input-field col s12">
                <input id="name" name="name" type="text" class="validate" maxlength="60">
